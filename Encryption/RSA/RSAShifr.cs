...
{
    public partial class RSAShifr : Form
    {
        ...
        {
            textP.Text = Show(rsa.p);
            textQ.Text = Show(rsa.q);
            textN.Text = Show(rsa.n);
            textF.Text = Show(rsa.f);
            textE.Clear();
            textD.Clear();
        ...
        {
            textE.Text = Show(rsa.e);
            textD.Text = Show(rsa.d);
        ...
        void ShifrRSA()
        {
            ...
            for (int row = 0; row < gridRSA.Rows.Count; row++)
            {
                ...
                int charEncrypting = rsa.ShifrMEssage(openMessage, e, n);
        ...
        void DeShifrRSA()
        {
            ...
            for (int row = 0; row < gridRSA.Rows.Count; row++)
            {
                ...
                // Дешифруем сообщение
                int charDecrypting = rsa.DeShifrMEssage(charEncrypting, d, n);
